...
<div class="container-fluid my-4">
  ...
  {{-- MODAL DE VENDA --}}
  <x-generic-modal id="sellModal" title="Vender: {{ $product->name }}" size="modal-lg">
    <form id="sellForm" method="POST" action="{{ route('product.sell', $product) }}">
      ...
      <div class="modal-footer d-flex justify-content-between flex-wrap gap-2 mt-4">
  ...
  {{-- MODAL DE EDIÇÃO --}}
  <x-generic-modal id="editProductModal" title="Editar Produto" size="modal-lg">
