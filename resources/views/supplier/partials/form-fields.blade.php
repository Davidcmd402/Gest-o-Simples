<div class="row">
    ...
    <div class="col-12 col-md-6 mb-3">
        ...
        <input type="text" name="phone_number" value="{{ old('phone_number', $supplier->phone_number ?? '') }}" class="form-control" required>
    </div>
    <div class="col-12 col-md-6 mb-3">
        <label>Rua</label>
    ...
    <div class="col-6 col-md-4 mb-3">
        <label>CEP</label>
        <input type="text" name="zip_code" value="{{ old('zip_code', $supplier->zip_code ?? '') }}" class="form-control" required>
    </div>
